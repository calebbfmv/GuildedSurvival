...
public class EditWeapon {
        public static Inventory inv (Player p){
            ...
            Inventory inv = Bukkit.createInventory(null, 36, ChatUtil.color("&bEdit Weapon"));
            ...
            woodLores.add(ChatUtil.color("&2of damage to your weapon."));
            woodLores.add(ChatUtil.color("&4Right click to remove 1 point"));
            woodLores.add(ChatUtil.color("&4of damage from your weapon."));
