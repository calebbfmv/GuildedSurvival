 ...
 */
public class AmmoCat {
    public static Inventory inv(){
        Inventory inv = Bukkit.createInventory(null, 45, ChatUtil.color("&bAmmo Category"));

        ItemStack dirt = new ItemStack(Material.ARROW, 1);
        ItemMeta dirtMeta = dirt.getItemMeta();
        dirtMeta.setDisplayName(ChatUtil.color("&bArrow"));
        ...
        dirtLore.add(ChatUtil.color("&b"+ Maps.blockCosts.get(Material.ARROW)+" &6coins."));
        dirtMeta.setLore(dirtLore);
        dirt.setItemMeta(dirtMeta);
        inv.setItem(0, dirt);

        ItemStack grass = new ItemStack(Material.SNOW_BALL, 1);
        ItemMeta grassMeta = grass.getItemMeta();
        grassMeta.setDisplayName(ChatUtil.color("&bLightning Bolt SnowBalls"));
        ...
        grassLore.add(ChatUtil.color("&b"+ Maps.blockCosts.get(Material.SNOW_BALL)+" &6coins."));
        grassMeta.setLore(grassLore);
        grass.setItemMeta(grassMeta);
        inv.setItem(1, grass);

        ItemStack cobble = new ItemStack(Material.MOB_SPAWNER, 1);
        ItemMeta cobbleMeta = cobble.getItemMeta();
        cobbleMeta.setDisplayName(ChatUtil.color("&bSpawner Bombs"));
        ...
        cobbleLore.add(ChatUtil.color("&b"+ Maps.blockCosts.get(Material.MOB_SPAWNER)+" &6coins."));
        cobbleMeta.setLore(cobbleLore);
        cobble.setItemMeta(cobbleMeta);
        inv.setItem(2, cobble);

        ItemStack stone = new ItemStack(Material.EMERALD, 1);
        ItemMeta stoneMeta = stone.getItemMeta();
        stoneMeta.setDisplayName(ChatUtil.color("&bFireball Emeralds"));
        ...
        stoneLore.add(ChatUtil.color("&b"+ Maps.blockCosts.get(Material.EMERALD)+" &6coins."));
